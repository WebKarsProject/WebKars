...
import { IAxiosData, IFiltred, IProviderProps, IUrlImg, IVehicleBody, IVehicleContext, IVehiclePost } from '../../interface'
...
const VehicleProvider = ({ children }: IProviderProps) => {
  ...
  const [filtred, setFiltred] = useState<IFiltred>({ brand: '', color: '', model: '', year: '', fuel: '' })
